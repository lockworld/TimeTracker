...
namespace WindowsAppBar
{
    ...
    public class DockedWindow : Window
    {
        ...
        static DockedWindow()
        {
            ShowInTaskbarProperty.OverrideMetadata(typeof(DockedWindow), new FrameworkPropertyMetadata(false));
            MinHeightProperty.OverrideMetadata(typeof(DockedWindow), new FrameworkPropertyMetadata(20d, MinMaxHeightWidth_Changed));
            MinWidthProperty.OverrideMetadata(typeof(DockedWindow), new FrameworkPropertyMetadata(20d, MinMaxHeightWidth_Changed));
            MaxHeightProperty.OverrideMetadata(typeof(DockedWindow), new FrameworkPropertyMetadata(MinMaxHeightWidth_Changed));
            MaxWidthProperty.OverrideMetadata(typeof(DockedWindow), new FrameworkPropertyMetadata(MinMaxHeightWidth_Changed));
        }
        ...
        public static readonly DependencyProperty DockModeProperty =
            DependencyProperty.Register("DockMode", typeof(AppBarDockMode), typeof(DockedWindow),
                new FrameworkPropertyMetadata(AppBarDockMode.Left, DockLocation_Changed));

        public MonitorInformation Monitor
        {
            get { return (MonitorInformation)GetValue(MonitorProperty); }
            set { SetValue(MonitorProperty, value); }
        }

        public static readonly DependencyProperty MonitorProperty =
            DependencyProperty.Register("Monitor", typeof(MonitorInformation), typeof(DockedWindow),
        ...
        public static readonly DependencyProperty DockedWidthOrHeightProperty =
            DependencyProperty.Register("DockedWidthOrHeight", typeof(int), typeof(DockedWindow),
        ...
        private MonitorInformation GetSelectedMonitor()
        {
            ...
            var allMonitors = MonitorInformation.GetAllMonitors();
